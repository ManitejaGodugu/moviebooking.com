class SuperCls:
    ...
    def allocate_seats(self):
        # Example seat allocation logic (assume seats are numbered 1 to 100)
        start_seat = 1  # Starting seat number (this can be dynamic)
        self.seats = list(range(start_seat, start_seat + self.members))
